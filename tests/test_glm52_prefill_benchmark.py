...
class TestGlm52PrefillBenchmark(unittest.TestCase):
    ...
    def test_run_decode_context_can_use_stream_mtp_speculative(self):
        ...
        self.assertEqual(
            calls[0]["mtp_adaptive_fallback_min_drafted_tokens"], 8
        )
        self.assertEqual(
            calls[0]["mtp_adaptive_fallback_min_acceptance_rate"], 0.50
        )
        self.assertFalse(calls[0]["prompt_checkpoint"])
        ...
        self.assertEqual(row["mtp_speculative_catchup_logits_skipped"], 0)
