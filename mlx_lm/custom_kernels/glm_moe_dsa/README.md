...
GLM-5.2-focused fork can build and run the native DSA indexer, sparse MLA, q8
V-up, and experimental q4 q projection routes without a runtime dependency on
the changing oMLX repository.
